...
// Exemplo real retornado pela API (documentação oficial cnpj.ws), usado apenas
// para validação visual offline dentro do sandbox do artifact, que bloqueia
// fetch para domínios externos. Fora daqui (StackBlitz/Claude Code), a
// chamada real à API funciona normalmente.
const MOCK_DATA_EXAMPLE = {
  cnpj_raiz: "27865757",
  ...
  estabelecimento: {
    ...
    estado: { id: 19, nome: "Rio de Janeiro", sigla: "RJ", ibge_id: 33 },
    cidade: { id: 3243, nome: "Rio de Janeiro", ibge_id: 3304557, siafi_id: "6001" },
    ...
    inscricoes_estaduais: [
      ...
      },
      {
        ...
        estado: { id: 26, nome: "São Paulo", sigla: "SP", ibge_id: 35 },
      },
    ],
  },
};
...
export default function App() {
  ...
  const handleLoadMock = () => {
    ...
    setLoading(false);
    setShowRaw(false);
    setCnpjInput(maskCNPJ("27865757000102"));
    setData(MOCK_DATA_EXAMPLE);
  };
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans">
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-3 sm:p-4 mb-6">
          ...
          >
            Carregar exemplo offline (sem chamar a API)
          </button>
        </div>
